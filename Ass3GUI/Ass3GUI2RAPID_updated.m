function Ass3GUI2RAPID_updated()
...
%                            tabapp.TextArea.Value = tablestate;
            ...
            if(mvapp.PvPButtonPressed)
                ...
                while(tttapp.EndGameButtonVal == 0)
...
%                 c1,c2,c3,c4,c5,c6,c7,c8,c9 = 0;
%                 while(TTTapp.EndGameButtonVal == 0)
%                     % AI goes first, and picks bottom left for win/draw
%                     if(firstMove == 0)
%                         % GUI handling
...
%                     % Now player turn
%                     if(moveCounter == 0)
%                         % If middle is not chosen, move to middle
%                         if(TTTapp.CellOneValue == 1 || TTTapp.CellFourValue == 1)
%                             TTTapp.CellSevenVal = 1;
%                             TTTapp.Cell7Button.Text = TTTapp.Player1;
%                             TTTapp.Cell7Button.FontSize = 28;
%                             TTTapp.Cell7Button.FontWeight = 'bold';
