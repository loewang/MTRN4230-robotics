...
%             if(testIOFlag == 0 && strcmp(app.TextArea.Text,'TestIO'))
%                 run('TestIO.m');
%             end
%             
%             if(testStatusFlag == 0 && strcmp(app.TextArea.Text,'TestStatus'))
%                 run('TestStatus.m');
%             end
% 
%             if(testMotionFlag == 0 && strcmp(app.TextArea.Text,'TestStatus'))
%                 run('TestMotion.m');
%             end
...
%                     robot_IP_address = '127.0.0.1'; % Simulation ip address
            ...
            if(strcmp(str,'1'))
                ...
                if(PrevConStat == 'g')
                    %ConvEnMsg = Message_ConveyorEnable();
